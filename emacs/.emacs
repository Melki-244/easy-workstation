...
(use-package bbdb :ensure t
  ...
  ;; (comment out to use Company autocompletion below)
  ...
  (add-hook 'message-mode-hook
            '(lambda ()
               ...
               (local-set-key (kbd "TAB") 'counsel-bbdb-complete-mail))))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(general counsel-bbdb ac-html-bootstrap ac-php bbdb-vcard bbdb evil-magit helm-ls-git magit ranger geben dashboard page-break-lines helm-ag helm-projectile projectile spaceline fancy-battery synosaurus define-word helm-flyspell ace-jump-mode linum-relative helm-tramp helm-swoop gruvbox-theme git-gutter-fringe git-gutter fringe-helper which-key web-beautify php-scratch yasnippet rainbow-mode flycheck-color-mode-line json-mode csv-mode sass-mode coffee-mode php-mode xah-css-mode web-mode aggressive-indent smooth-scrolling exec-path-from-shell multi-term ox-epub flycheck-plantuml plantuml-mode org-bullets autopair swiper helm evil-commentary evil-tutor evil-surround evil-matchit evil xclip diminish use-package)))
